...
function AnalystNewIngredientPage({ isMobile, onBack }) {
    ...
    <section style={containerStyle(isMobile)}>
      ...
      <form onSubmit={handleSubmit} style={panelStyle}>
        ...
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
          <button type="submit" style={primaryButtonStyle} disabled={saving}>{saving ? 'Guardando...' : 'Crear ingrediente'}</button>
