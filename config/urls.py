...
urlpatterns = [
    ...
    path('api/admin/compras/borrador/editar/', admin_compra_borrador_editar_view, name='admin-compra-borrador-editar'),
    ...
    path('api/admin/reportes/conciliacion-bancaria/', reporte_conciliacion_bancaria_view, name='admin-reporte-conciliacion-bancaria'),
    path('api/admin/reportes/ventas-dia/', reporte_ventas_dia_view, name='admin-reporte-ventas-dia'),
    path('api/admin/reportes/ventas-dia/<int:nota_id>/', reporte_venta_nota_detalle_view, name='admin-reporte-venta-nota-detalle'),
    ...
    path('api/mesas/ocupadas/', mesas_ocupadas_view, name='mesas-ocupadas'),
    path('api/pedidos/mesas-atendidas/mover/', mesa_atendida_mover_view, name='mesas-atendidas-mover'),
    path('api/pedidos/delivery/', pedidos_delivery_view, name='pedidos-delivery'),
    ...
    path('api/pedidos/<int:pedido_id>/items/<int:detalle_id>/eliminar/', pedido_detalle_eliminar_view, name='pedido-detalle-eliminar'),
    path('api/pedidos/<int:pedido_id>/items/<int:detalle_id>/mover/', pedido_detalle_mover_view, name='pedido-detalle-mover'),
    path('api/pedidos/<int:pedido_id>/items/<int:detalle_id>/reimprimir/', pedido_detalle_reimprimir_view, name='pedido-detalle-reimprimir'),
    path('api/pedidos/meseros-disponibles/', meseros_disponibles_view, name='meseros-disponibles'),
    ...
    path('api/facturas/<int:factura_id>/reimprimir/', factura_reimprimir_view, name='factura-reimprimir'),
    path('api/notas-entrega/', notas_entrega_view, name='notas-entrega'),
    path('api/notas-entrega/<int:nota_id>/', nota_entrega_detail_view, name='nota-entrega-detail'),
